...
for i in `ls -t  /p/project/ccstdl/wortsman1/open_clip_fork/logs/*/checkpoints/poly_8_1*.pt`
do
    model='ViT-B-32'
    ...
    if [ -f "$save_path" ]; then
        ...
        --save-most-recent --resume $new_i --averagers poly_8_1 \
...
# --save-most-recent --resume /p/project/ccstdl/wortsman1/open_clip_fork/logs/cosine1b/checkpoints/epoch_1.pt --averagers poly_8_1 \
