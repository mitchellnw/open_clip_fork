    ...
    def step(
        ...
        for group in self.param_groups:
            ...
            for p in filter(lambda p: exists(p.grad), group['params']):
                ...
                grad, lr, wd, beta1, beta2, state = p.grad, group['lr'], group['weight_decay'], group['beta1'], group['beta2'], self.state[p]
...
#                 update_fn(theta, g, v, u, lr, weight_decay, beta1hat, beta2hat, self.eps, self.update_clip)
