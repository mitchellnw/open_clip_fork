...
class MomentAdamW(torch.optim.Optimizer):
    ...
    def __init__(self, params, lr=0.004, weight_decay=0.2, betas=(0.9, 0.999), eps=1e-6, individual_betas=False):
        ...
        super(MomentAdamW, self).__init__(params, defaults)
        ...
        print('Using MomentAdamW-v1')


    def __setstate__(self, state):
        super(MomentAdamW, self).__setstate__(state)
        
    # One MomentAdamW step
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                u = u.mul_(beta2hat).addcmul_(v,v,value=1.0-beta2hat)
