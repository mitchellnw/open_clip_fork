modules_to_log = [
    ...
    'module.visual.transformer.resblocks.1.attn.in_proj_weight',
    'module.visual.transformer.resblocks.1.attn.in_proj_bias',
    'module.visual.transformer.resblocks.1.attn.out_proj.weight',
    'module.visual.transformer.resblocks.1.attn.out_proj.bias',
    'module.visual.transformer.resblocks.1.ln_2.weight',
    'module.visual.transformer.resblocks.1.ln_2.bias',
    'module.visual.transformer.resblocks.1.mlp.c_fc.weight',
    'module.visual.transformer.resblocks.1.mlp.c_fc.bias',
    'module.visual.transformer.resblocks.1.mlp.c_proj.weight',
    'module.visual.transformer.resblocks.1.mlp.c_proj.bias',
