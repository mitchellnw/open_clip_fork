...
if __name__ == "__main__":
    for seed in [0]:
        ...
        args.beta2 = 0.98
        args.init_beta2 = 0.88
        args.warmup_beta2 = 10000

        name = f'clip-h14-ls0-400m-l0-opt-{args.lr}-{args.beta1}-{args.beta2}-{args.eps}-bs-{args.batch_size * args.ngpus * args.nodes}-{args.precision}-v{args.seed}-wb2-{args.init_beta2}-{args.warmup_beta2}'
