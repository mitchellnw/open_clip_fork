...
if __name__ == "__main__":
    ...
    for res in [2]:
        for seed in [0]:
            ...
            args.partition = 'scavenge'#'learnlab'
            ...
            args.warmup = 10000
            args.resume = f'/checkpoint/mitchellw/experiments/open_clip/clip-h14-400m-l0-opt-0.0005-0.9-0.98-1e-06-bs-8192-amp-v{seed}/checkpoints/iter_91620.pt'

            name = f'clip-h14-400m-l0-opt-{args.lr}-{args.beta1}-{args.beta2}-{args.eps}-bs-{args.batch_size * args.ngpus * args.nodes}-{args.precision}-v{args.seed}-resume{res}'
