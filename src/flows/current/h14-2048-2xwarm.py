...
if __name__ == "__main__":
    ...
    args.warmup = 5000*2
    #args.resume = '/checkpoint/mitchellw/experiments/open_clip/h14-400m-opt-0.001-0.9-0.98-1e-06-bs-2048-amp-v1/checkpoints/iter_34188.pt'



    name = f'h14-400m-opt-{args.lr}-{args.beta1}-{args.beta2}-{args.eps}-bs-{args.batch_size * args.ngpus * args.nodes}-{args.precision}-v{args.seed}-2xwarm'
