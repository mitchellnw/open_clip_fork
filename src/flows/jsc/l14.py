...
if __name__ == "__main__":
    ...
    args.train_num_samples = 100000000
    ...
    args.srun_args = True
    name = f'l14-2b-l0-opt-{args.lr}-{args.beta1}-{args.beta2}-{args.eps}-bs-{args.batch_size * args.ngpus * args.nodes}-{args.precision}-v{args.seed}'
