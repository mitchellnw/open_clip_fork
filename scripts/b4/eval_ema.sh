...
for i in `ls -t  /fsx/home-mitchellw/experimetns/opt4/*/checkpoints/ema*.pt`
do
    # model=${i:52:8}
    ...
    if [ -f "$save_path" ]; then
        ...
        if [[ $save_path == *"sglint8"* ]]; then
            ...
            --save-most-recent --resume $new_i --custom-attention vanilla --sglint8 \
            --imagenet-val /fsx/rom1504/imagenetval/imagenet_validation --ema &> $save_path
        elif [[ $save_path == *"slint8"* ]]; then
            echo "$save_path does not exist -- slint8."
            torchrun --nproc_per_node 2 -m training.main \
            --batch-size 200   --workers 4 --model $model  --train-num-samples 413000000  \
            --local-loss  --gather-with-grad     --grad-checkpointing       --precision custom_fp16  \
            --save-most-recent --resume $new_i --custom-attention vanilla --slint8 \
            --imagenet-val /fsx/rom1504/imagenetval/imagenet_validation --ema &> $save_path
            ...
            --batch-size 200   --workers 4 --model $model  --train-num-samples 413000000  \
            --local-loss  --gather-with-grad     --grad-checkpointing       --precision custom_fp16  \
            --save-most-recent --resume $new_i --custom-attention vanilla --int8mix \
            --imagenet-val /fsx/rom1504/imagenetval/imagenet_validation --ema &> $save_path
            ...
            --batch-size 200   --workers 4 --model $model  --train-num-samples 413000000  \
            --local-loss  --gather-with-grad     --grad-checkpointing       --precision custom_fp16  \
            --save-most-recent --resume $new_i --custom-attention vanilla --fp8mix \
            --imagenet-val /fsx/rom1504/imagenetval/imagenet_validation --ema &> $save_path
            ...
            --save-most-recent --resume $new_i --custom-attention extra_ln \
            --imagenet-val /fsx/rom1504/imagenetval/imagenet_validation --ema &> $save_path
        else
            ...
            --batch-size 200   --workers 4 --model $model  --train-num-samples 413000000  \
            --local-loss  --gather-with-grad     --grad-checkpointing       --precision amp_bfloat16  \
            --save-most-recent --resume $new_i --custom-attention vanilla \
            --imagenet-val /fsx/rom1504/imagenetval/imagenet_validation --ema &> $save_path
        fi
    fi
done
...
###
#rm /fsx/home-mitchellw/experimetns/opt4/clipadamw-const_poly_8_1-ViT-B-32-16384-1e-3-0.99-100-v0/checkpoints/eval_ema_1_27.pt
#rm /fsx/home-mitchellw/experimetns/opt4/clipadamw-const_poly_8_1-ViT-B-32-16384-5e-4-0.99-100-v0/checkpoints/eval_ema_1_27.pt
#rm /fsx/home-mitchellw/experimetns/opt4/clipadamw-const_poly_8_1-ViT-B-32-16384-2e-3-0.99-100-v0/checkpoints/eval_ema_1_26.pt
###