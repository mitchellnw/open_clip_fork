...
EXP_NAME="$OPT-$MODEL-$BS-$LR-$BETA2-test-v0"

srun --comment laion --cpu_bind=v --accel-bind=gn python -m training.main \
    --save-frequency 1 \
    --train-data="pipe:aws s3 cp s3://r2poc/laion2B-en/{00000..18000}.tar --endpoint-url https://fa7a2a10f5d6e5319d8a01ff4e802e89.r2.cloudflarestorage.com/ --profile r2poc -"  \
