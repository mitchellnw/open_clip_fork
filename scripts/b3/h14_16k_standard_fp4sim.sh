...
#SBATCH --exclusive
#SBATCH --time=4320
#SBATCH --exclude=ip-26-0-138-237,ip-26-0-143-249,ip-26-0-130-73,ip-26-0-134-96
#SBATCH --requeue
...
# self.fw_code = bnb.functional.create_fp8_map(True, 2, 1, 4).to(x.device)
...
EXP_NAME="$OPT-camp65kfp4sim4-$MODEL-$BS-$LR-$BETA2-v0"
