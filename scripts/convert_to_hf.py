...
if __name__ == "__main__":
    ...
    parser.add_argument("--pytorch_dump_folder_path", default='/fsx/home-mitchellw/dump', type=str, help="Path to the output PyTorch model.")
    parser.add_argument("--model", default='ViT-bigG-14', type=str, help="Path to fairseq checkpoint")
    parser.add_argument("--pretrained", default='/fsx/home-mitchellw/bigG_14.pt', type=str, help="Path to fairseq checkpoint")
    parser.add_argument("--config_path", default='/admin/home-mitchellw/hf/CLIP-ViT-bigG-14-laion2B-39B-b160k/config.json', type=str, help="Path to hf config.json of model to convert")
