...
if __name__ == '__main__':
    ...
    bsz = 4096*4
    file_list = [
        #(f'adamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'AdamW 0.99', cmap(1.), -1),
        #(f'customadamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'CustomAdamW 0.99', cmap(0.), -1),
        #(f'oldcustomadamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'CustomAdamW 0.99', cmap(0.5), -1),
        
        #(f'customadamw-ViT-B-32-{bsz}-2e-3-0.95-v0', 'CustomAdamW 0.9','k', 800),
        #(f'customadamw-ViT-B-32-16384-2e-3-0.95-v0', 'CustomAdamW 0.99',cmap(0.), -1),
        
        
        #(f'customadamw-ViT-B-32-16384-2e-3-0.995-v0', 'Standard',cmap(1.), -1),
        #(f'customadamw-ViTDP-B-32-{16384*4}-2e-3-0.9-v0', 'Dual Patchnorm',cmap(0.), -1),
        #(f'customadamw-ViTDP-B-32-{16384*4}-2e-3-0.995-v0', 'Dual Patchnorm',cmap(0.), -1),
        #(f'customadamw-ViT-B-32-{16384}-2e-3-0.99-v0', 'Standard',cmap(1.), -1),
        #(f'clipadamw-ViT-B-32-{16384}-2e-3-0.99-v0', 'Update Clip', cmap(2./3), -1),
        (f'customadamw-ViTDP-B-32-{16384*4}-2e-3-0.98-v0', 'Dual Patchnorm',cmap(1./3), -1),
        #(f'clipadamw-ViTDP-B-32-{16384}-2e-3-0.99-v0', 'Update Clip + Dual Patchnorm',cmap(0.), -1),
        #(f'customadamw-ViTDP-B-32-{16384*4}-2e-3-0.995-v0', 'Dual Patchnorm',cmap(0.), -1),
        #(f'customadamw-ViTDP-B-32-{16384*4}-2e-3-0.995-v0', 'Dual Patchnorm',cmap(1.), -1),

        #(f'clipadamw-ViTDP-B-32-{4*16384}-2e-3-0.995-v0', 'Dual Patchnorm + clipping',cmap(1.), -1),



        
       # (f'customadamw-ViT-B-32-{bsz}-2e-3-0.5-v0', 'Beta2 = 0.5', cmap(0.), -1),
        
        # (f'customadamw-ViT-B-32-{bsz}-2e-3-0.9-v0', 'Beta2 = 0.9', cmap(0.5), -1),
        # (f'customadamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'Beta2 = 0.99', cmap(1.), -1),

        # (f'customadamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'CustomAdamW 0.99', cmap(1.), -1),
        #(f'clipadamw-ViT-B-32-{bsz}-2e-3-0.95-v0', 'clipAdamW 0.99', cmap(0.5), -1),
        #(f'clipadamw-2-ViT-B-32-{bsz}-2e-3-0.95-v0', 'clipAdamW 0.99', cmap(1.), -1),
        #(f'customadamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'CustomAdamW 0.99', cmap(1.), -1),
        #(f'customadamw-ViT-B-32-{bsz*4}-2e-3-0.99-v0', 'CustomAdamW 0.99', cmap(0.), -1),
        #
        #(f'customadamw-ViT-B-32-{bsz}-2e-3-0.9-v0', 'CustomAdamW 0.99', cmap(0.5), -1),
        #(f'clipadamw-ViT-B-32-{bsz}-2e-3-0.999-v0', 'CustomAdamW 0.9', cmap(0.), -1),
        
        # (f'stableadamw-2-ViT-B-32-{bsz}-2e-3-0.6-v0', 'CustomAdamW 0.9', cmap(0.), -1),
        # (f'stableadamw-2-ViT-B-32-{bsz}-2e-3-0.8-v0', 'CustomAdamW 0.9', cmap(0.5), -1),
        # (f'stableadamw-2-ViT-B-32-{bsz}-2e-3-1.0-v0', 'CustomAdamW 0.9', cmap(1.0), -1),
        
        #(f'stableadamw-1-ViT-B-32-{bsz // 4}-2e-3-0.333-v0', 'CustomAdamW 0.9', cmap(0./3), -1),
        
        #(f'stableadamw-1-ViT-B-32-{bsz}-2e-3-0.333-v0', 'CustomAdamW 0.9', cmap(1./3), -1),
        
        #(f'stableadamw-1-ViT-B-32-{bsz* 4}-2e-3-0.333-v0', 'CustomAdamW 0.9', cmap(2./3), -1),
        # (f'stableadamw-1-ViT-B-32-{bsz*4}-2e-3-0.333-v0', 'CustomAdamW 0.9', 'k', -1),
        # (f'stableadamw-1-ViT-B-32-{bsz}-2e-3-0.25-v0', 'CustomAdamW 0.9', cmap(2./3), -1),
        #(f'stableadamw-1-ViT-B-32-{bsz}-2e-3-0.2-v0', 'CustomAdamW 0.9', cmap(1.), -1),
        #(f'stableadamw-1-ViT-B-32-{bsz}-2e-3-0.15-v0', 'CustomAdamW 0.9', cmap(1.), -1),
        #(f'stableadamw-1-ViT-B-32-{bsz}-2e-3-12-v0', 'CustomAdamW 0.9', cmap(1.), -1),
        #(f'customadamw-ViT-B-32-{bsz}-2e-3-0.99-v0', 'CustomAdamW 0.99', cmap(1.), -1),
    ...
    for j, (file, name, color, lim) in enumerate(file_list):
        ...
        for jj, module in enumerate(modules):
            ...
            for i in range(1):
                ...
                #idx = 18
                if jj == 0:
                    ax.plot(df.iloc[:, 0],np.sqrt(df.iloc[:, 14]), color=color, alpha=alpha)
                    #ax.plot(df.iloc[:, 0],df.iloc[:, 17], color=color, alpha=alpha)
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/loss_plot_minmax.png', bbox_inches='tight')
