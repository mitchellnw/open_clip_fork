...
if __name__ == '__main__':
    ...
    file_list = [
        ...
        #(f'clipadamw-amp-ViTDP-H-14-16384-2e-3-0.95-v1', 'fp16-98',cmap(2./3), -1),
        #(f'clipadamw-amp-ViTDP-H-14-16384-2e-3-0.98-v1', 'fp16-98',cmap(2./3), -1),
        #(f'clipadamw-amp-ViTDP-H-14-16384-2e-3-0.95-v1', 'fp16-95',cmap(1.), -1),
        ...
        #(f'customadamw-ViT-L-14-16384-2e-3-0.98-v2', 'fp16-95',cmap(1.), -1),

        #(f'customadamw-amp-ViT-L-14-16384-2e-3-0.98-v1-nopd', 'fp16-98', 'gray', -1),
        (f'clipadamw-amp-ViTDP-H-14-16384-2e-3-0.98-v1_backup', 'fp16-98',cmap(2./3), -1),
    ]
    ...
    for j, (file, name, color, lim) in enumerate(file_list):
        ...
        ax = axlist[-1]
        for i in range(1):
            layer = f'features2-module.visual.transformer.resblocks.20.csv'
            ...
            ax.set_ylabel('feature max layer 20', fontsize=16)
