...
if __name__ == '__main__':
    ...
    file_list = [        
        ...
        (f'clipadamw-camp65kfp8global-ViT-H-14-16384-2e-3-0.98-v0', 'H/14 all global','C5', 9800),
        (f'clipadamw-camp65kfp8newsim-ViT-H-14-16384-2e-3-0.98-v0', 'H/14 mix global/row','C4', ll),
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/paper/fp8baseh.png', bbox_inches='tight')
