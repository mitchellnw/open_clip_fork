...
if __name__ == '__main__':
    ...
    file_list = [        
        ...
        (f'clipadamw-camp65kfp8global-ViT-B-32-16384-2e-3-0.98-v0', 'B/32 all global','C5', ll),
        (f'clipadamw-camp65kfp8newsim-ViT-B-32-16384-2e-3-0.98-v0', 'B/32 mix global/row','C4', ll),
    ...
    for j, ax in enumerate(axlist):
        ...
        ax.legend(fontsize=13, bbox_to_anchor=(0.9, -0.15), ncol=2)
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/paper/fp8baseb.png', bbox_inches='tight')
