...
if __name__ == '__main__':
    ...
    fig, axlist = plt.subplots(log_level, 1, figsize=(6, 3*log_level))
    if log_level == 1:
        axlist = [axlist]
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/paper/fp8lbreakdown2.png', bbox_inches='tight')
