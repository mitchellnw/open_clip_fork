...
# clipadamw-int4sim-ViT-B-32-16384-2e-3-0.98-v0
        ...
        # H
        # (f'clipadamw-amp-ViT-H-14-16384-2e-3-0.98-long-v0', 'long1','C0', ll),
        # (f'clipadamw-camp65k-ViT-H-14-16384-2e-3-0.98-long-v0', 'long2','C1', ll),

        (f'customadamw-amp-ViT-H-14-16384-2e-3-0.98-long-v0', 'long1','C0', ll),
        (f'customadamw-camp65k-ViT-H-14-16384-2e-3-0.98-long-v0', 'long2','C1', ll),
        (f'customadamw-amp-ViT-H-14-16384-2e-3-0.98-long-nopd-v0', 'long3','C2', ll),
        ...
        # (f'clipadamw-camp65kfp8newsim-ViT-H-14-16384-2e-3-0.98-v0', 'fp8 sim new','C4', ll),
...
# lion-ViT-H-14-16384-5e-4-0.98-wd2beta195-v0
        ...
        for jj, module in enumerate(modules):
            ...
            for i in range(1):
                ...
                for axv in df[np.isnan(df[6])][0].values:
                    ax.axvline(axv, color='red', alpha=0.1)
                    badness += 1
                for axv in df[np.isinf(df[6])][0].values:
                    ax.axvline(axv, color='red', linestyle='--', alpha=0.1)
                    badness += 1
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/opt3_lp_long.png', bbox_inches='tight')
