...
if __name__ == '__main__':
    ...
    ll =-1
    file_list = [      
        # (f'customadamw-ViT-B-32-8192-2e-3-0.98-laion5b-v1', 'laion5b','C0', ll),
        # (f'customadamw-ViT-B-32-8192-2e-3-0.98-cc12m-v1', 'cc12m','C1', ll),  
        (f'customadamw-ViT-B-32-8192-2e-3-0.98-reddit-v1', 'reddit','C2', ll),  
        # (f'customadamw-ViT-B-32-8192-2e-3-0.98-yfcc-v1', 'yfcc','C3', ll),  
        # (f'customadamw-ViT-B-32-8192-2e-3-0.98-wit-v1', 'wit','C4', ll),  
        # (f'customadamw-ViT-B-32-8192-2e-3-0.98-shutterstock-v1', 'shutterstock','C5', ll),  
        # # (f'clipadamw-ViT-B-32-8192-2e-3-0.98-laion5b-v1', 'laion5b + update clip','C6', ll),
        # (f'clipadamw-ViT-B-32-8192-2e-3-0.98-shutterstock-v1', 'shutterstock + update clip','C7', ll),  
        # (f'customadamw-ViT-B-32-8192-2e-3-0.98-shutterstock-gc1-v1', 'shutterstock + grad clip','C8', ll),  
        # (f'clipadamw-ViTDP-B-32-8192-2e-3-0.98-shutterstock-v1', 'shutterstock + input norm','C9', ll), 
        # (f'clipadamw-ViT-B-32-8192-2e-3-0.9-shutterstock-v1', 'shutterstock + update clip + low beta2','k', ll),
        (f'customadamw-ViT-B-32-8192-2e-3-0.98-byod-v1', 'byod','k', ll),  
        #(f'clipadamw-ViT-B-32-8192-2e-3-0.98-byod-v1', 'byod','gray', ll),  
...
# clipadamw-int4sim-ViT-B-32-16384-2e-3-0.98-v0
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/opt3_lp_data.png', bbox_inches='tight')
