...
if __name__ == '__main__':
    ...
    file_list = [        
        ...
        (f'ldog-ViT-B-32-16384-1-0.98-skipcwd1en4-v0', 'LDoG (wd 1e-4)','C1', ll),
        (f'ldog-ViT-B-32-16384-1-0.98-skipcwd0-v0', 'LDoG (wd 0)','C2', ll),
        (f'lion-ViT-B-32-16384-2e-4-0.99-v0', 'lion','C5', ll),
        (f'rlion-ViT-B-32-16384-2e-4-0.99-v0', 'lion - no momentum','C6', ll),
...
# clipadamw-int4sim-ViT-B-32-16384-2e-3-0.98-v0
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/opt3_lp_lion.png', bbox_inches='tight')
