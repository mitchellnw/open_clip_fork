...
# Purple: #9467BD
        ...
        for template, name, color, marker in [
            ('opt/customadamw-ViT-{}-16384-2e-3-0.99-v0', 'beta2 = 0.99', cmap(1.), -1),
            ('opt3/clipadamw-ViT-{}-16384-2e-3-0.99-v0', 'clip = 0.99','C1', -1),
            ('opt3/customadamw-ViTDP-{}-16384-2e-3-0.99-v0', 'clip = 0.99','C2', -1),
            ('opt3/customadamw-ViT-{}-16384-2e-3-0.99-gc-v0', 'gc', 'C3', -1),
