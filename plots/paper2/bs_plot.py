...
if __name__ == '__main__':
    ...
    for k, model in enumerate(['B-32-4096', 'B-32-16384', 'B-32-65536']):
        ...
        # for k, model in enumerate(['B-32-4096', 'B-32-16384', 'B-32-65536']):
        if k == 0:
            ax.set_title("Base model, batch size = 4096", fontsize=12)
        elif k == 1:
            ax.set_title("Base model, batch size = 16384", fontsize=12)
        else:
            ax.set_title("Base model, batch size = 65536", fontsize=12)
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/paper2/bs_plot.pdf', bbox_inches='tight')
