...
if __name__ == '__main__':
    ...
    for k, model in enumerate(['B-32-16384-5e-4', 'B-32-16384-2e-3', 'B-32-16384-5e-3']):
        ax = fig.add_subplot(gs[0, k])
        axins2 = zoomed_inset_axes(ax, zoom=4, loc=1)

        for template, name, color, marker in [
            ('customadamw-ViT-{}-0.99-v0', 'beta2 = 0.99',cmap(1.), -1),
            ('customadamw-ViT-{}-0.98-v0', 'beta2 = 0.98',cmap(3./4), -1),
            ('customadamw-ViT-{}-0.95-v0', 'beta2 = 0.95',cmap(2./4), -1),
            ('customadamw-ViT-{}-0.9-v0', 'beta2 = 0.9',cmap(1./4), -1),
            ('customadamw-ViT-{}-0.5-v0', 'beta2 = 0.5',cmap(0./4), -1),
            
            
            # ('customadamw-ViT-{}-2e-3-0.5-v0', 'beta2 = 0.5',cmap(0./4), -1),
            # ('customadamw-ViT-{}-2e-3-0.9-v0', 'beta2 = 0.9',cmap(1./4), -1),
            # ('customadamw-ViT-{}-2e-3-0.95-v0', 'beta2 = 0.95',cmap(2./4), -1),
            # ('customadamw-ViT-{}-2e-3-0.98-v0', 'beta2 = 0.98',cmap(3./4), -1),
            # ('customadamw-ViT-{}-2e-3-0.99-v0', 'beta2 = 0.99',cmap(1.), -1),
        ...
        # for k, model in enumerate(['B-32-4096', 'B-32-16384', 'B-32-65536']):
        if k == 0:
            ax.set_title("Base model, LR = 5e-4", fontsize=12)
        elif k == 1:
            ax.set_title("Base model, LR = 2e-3", fontsize=12)
        else:
            ax.set_title("Base model, LR = 5e-3", fontsize=12)
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/paper2/lr_plot.pdf', bbox_inches='tight')
