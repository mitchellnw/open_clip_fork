...
if __name__ == '__main__':
    ...
    for k, model in enumerate(['B-32', 'L-14']):
        ax = fig.add_subplot(gs[0, k])
        axins2 = zoomed_inset_axes(ax, zoom=8, loc=1)
        ...
        if k == 1:
            leg = ax.legend(bbox_to_anchor=(0.95, -0.27), ncol=5,fontsize=9.5)
    ...
    plt.savefig('/admin/home-mitchellw/forks/open_clip_fork/plots/paper2/beta2_plot_v0.pdf', bbox_inches='tight')
